...
<body id="page-top">
<!-- Navigation -->
<header><nav class="navbar navbar-default navbar-fixed-top navbar-custom" role="navigation">
	<div class="container">
		<div class="navbar-header">
			...
			<a class="navbar-brand page-scroll" href="#page-top">
				<img class="img-responsive" src="img/smalllogo.jpg" alt="SpotX"></a>
		</div>
		<div id="navigation-collapse" class="collapse navbar-collapse"><ul class="nav navbar-nav navbar-right">
			<li><a class="page-scroll" href="#whyspotx" data-content="WHY SPOT X?">WHY SPOT X?</a></li>
			<li><a class="page-scroll" href="#spotxunique" data-content="WHAT MAKES SPOT X UNIQUE?">WHAT MAKES SPOT X UNIQUE?</a></li>
			<li><a class="page-scroll" href="#servicecoverage" data-content="SERVICE PRICING AND COVERAGE">SERVICE PRICING AND COVERAGE</a></li>
			<li><a class="page-scroll" href="#techsupport" data-content="TECH AND SUPPORT">TECH AND SUPPORT</a></li>
			<li><a class="page-scroll" href="#inthenews" data-content="IN THE NEWS">IN THE NEWS</a></li>                
			<li><a class="page-scroll" href="#howtogetspotx" data-content="HOW TO GET SPOT X">HOW TO GET SPOT X</a></li>
		</ul></div>                    
	</div>
</nav></header>

<!-- Main Carousel -->
<section id="main-carousel"><div id="myCarousel" class="carousel slide" data-ride="carousel">
...
<!-- SpotX 360 -->
<section id="spotx360"><div class="container"><div class="row">
	<div class="col-xs-12 col-sm-6 text360 opensans pull-right text-left">
		...
		<div class="price-var third360">$199.99<br/></div>
		<div class="third360 price-var-txt">at participating retailer</div><br/>
		<div id="fourth360"class="price-msrp">$249.99 <span class="price-msrp-txt">MSRP</span></div>
	</div>
	<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 imgDiv">
        ...
        <section id="whyspotx">
                <div id="whyspotxheading" class="oswald text-center whyspotx-header">
                  <h2 id="whyspotxheadertext">WHY SPOT X?</h2>
                  <hr id="whyspotx-underline" class="row-fluid">
                </div>
        ...
        <section id="spotxunique" class="orangebg space">
            <div class=" container unique-container">
                ...
                <div id="spotxunique-container" class="col-xs-12 col-md-12 col-lg-12 col-xl-12 row-fluid">
                    ...
                    <div id="impactresistant" class="spotxfeature ring">
                        <div class="circle">
                            <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" class="isHidden svg-content"> 
                    ...
                    <div id="rechargeable" class="spotxfeature ring">
                        <div class="circle">
                            <svg xmlns="http://www.w3.org/2000/svg" width="200" height="100" class="isHidden svg-content" > 
                    ...
                    <div id="audionotify" class="spotxfeature ring">
                    ...
                    <div id="hours360" class="spotxfeature ring">
                        <div class="circle">
                            <svg xmlns="http://www.w3.org/2000/svg" width="200" height="250" class="isHidden svg-content"> 
                    ...
                    <div id="usbport" class="ring">
                        <div class="circle">
                            <svg xmlns="http://www.w3.org/2000/svg" width="200" height="50" class="isHidden svg-content"> 
                    ...
                    <div id="thin" class="spotxfeature ring">
                        <div class="circle">
                            <svg xmlns="http://www.w3.org/2000/svg" width="200" height="50" class="isHidden svg-content"> 
                        ...
                        <div id="backlitdisplay" class=" spotxfeature ring">
                            <div class="circle">
                                <svg xmlns="http://www.w3.org/2000/svg" width="200" height="50" class="isHidden svg-content"> 
        ...
        <section id="servicecoverage" class='space'>
        ...
        <section id="inthenews">
            ...
            <hr id="inthenews-underline">
                ...
                <button id="presskit" class="btn btn-primary oswald">DOWNLOAD SPOT X PRESS KIT</button>

        </section>

<!-- How to get SpotX -->
<section id="howtogetspotx">
	<h2 id="getspotx-header">HOW TO GET SPOT X</h2>
	<hr class="black-underline-howtogetspotx"/>
	<h4 id="getspotx-headercopy" class="oswald">SPOT X IS COMING SOON. NOTIFY ME WHEN IT&#39S AVAILABLE.</h4>
	...
	<div class="row"><div class="col-xs-8 col-xs-offset-2">
		...
		<input name="name" type="text" class="form-control" id="name"  pattern=".{2,}" required>
		<label for="email">EMAIL ADDRESS*</label><br />
		<input name="email" type="email" class="form-control email" id="email" required>
		...
		<input name="TandC" type="checkbox" id="i_agree" class="pull-left" value="Terms and Conditions" required> 
		<p class="pull-left"><a id="terms" href="http://www.globalstar.com/en/index.php?cid=4340" target="_blank">
			I agree to terms &amp; conditions</a></p>
		<p class="pull-right">(*Required)</p>
		</div></div>
		<div id="error_msg_info_form"></div>
		<div class="col-xs-12"><br>
			<button id="submit" type="submit" class="btn btn-primary">NOTIFY ME</button>
		</div>
